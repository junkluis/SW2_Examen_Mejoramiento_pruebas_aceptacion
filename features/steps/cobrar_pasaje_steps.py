...
def before_scenario(context, scenario): context = {}
...
def step_impl(context, variable): print(variable)
	pass
...
@given("que tengo ${dolares} dolares en mi carnet de codigo {codigo}")
...
def descontarPasaje(context):
	retorno = 
	_pasaje_ruta(context.ruta, context.carnet, context.internet)
