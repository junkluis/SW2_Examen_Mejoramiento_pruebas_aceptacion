...
if __name__ == '__main__':
    ...
    movie_A = Pelicula(
        "Carrie", "Brian De Palma", [
            "John Travolta", "William Katt", "Betty Buckley"], "suspenso", [
            "ingles", "español"], 1976, "R")
    movie_B = Pelicula(
        "The Adventures Of Tinti", "Steven Spielberg", [
            "Jamie Bell", "Andy Serkis", "Daniel Craig"], "suspenso", [
            "ingles", "español"], 2011, "PG")
    movie_C = Pelicula("The Bourne Identity ",
                       "Brian De Palma",
                       ["Matt Damon",
                        "Franka Potente",
                        "Chris Cooper"],
                       ...
                       "PG-13")
    movie_D = Pelicula(
        "The Great Dictator ", "Doug Liman", [
            "Charlie Chaplin", "Paulette Goddard", "Jack Oakie"], "comedia", [
            "ingles", "esperanto"], 1940, "PG")
    ...
    resultado, msj, error = get_pelicula_rating(
        lista_peliculas, ["R", "PG", "RC1"])
    print(msj)
    print(error)
    for x in resultado:
        print(x)
